...
const testEnv = { ...process.env, AUTH_SECRET: "local-e2e-secret-only", DATABASE_URL: databaseUrl, DIRECT_URL: databaseUrl };
try {
  // Exercise the exact deploy command, not just its SQL, against the isolated database.
